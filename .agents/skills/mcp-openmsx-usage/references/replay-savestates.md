...
5. **Set breakpoint** near suspected cause: `debug_breakpoints { command: "create", address: "0x4100" }` — or, to catch an unexpected memory write: `debug_watchpoints { command: "create", type: "write_mem", begin: "0x4100", end: "0x41FF" }`
